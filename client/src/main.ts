...
export const hello: ClientEnvelope = {schema_version:2,message:{kind:'hello',protocol_version:2,last_revision:null,slot_token:null}};
...
try {
  ...
  if(status) status.textContent='Unit reference could not be loaded. Restart the server and refresh.';
}
