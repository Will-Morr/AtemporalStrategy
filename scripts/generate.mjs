...
execFileSync('cargo', ['run','--locked','--quiet','-p','atemporal-tools','--','guide'], {cwd:root,stdio:'inherit'});
const schema = JSON.parse(await readFile(new URL('../schemas/contracts-v1.json', import.meta.url),'utf8'));
