...
Team result text explains that survival points are awarded only if at least one player was eliminated. Stalemates and all-eliminated draws show zero score deltas.
