...
- [ ] Deterministic world and simulation — simulation agent
  ...
  - [ ] Active-building OR no-build-ability elimination, three outcome kinds, inactivity cutoff/future-event guards, backup horizon, state/events/statistics export.
...
- [ ] Match controller, worker and archive — server agent
  ...
  - [ ] Q3 timed boundary, FFA/team survivor scoring, fixed-target/lead thresholds, thinking time and configurable penalties.
